...
import { ListarSelecaoComponent } from './components/selecao/listar-selecao/listar-selecao.component';
import { ListarSelecoesComponent } from './components/pages/selecao/listar-selecoes/listar-selecoes.component';

@NgModule({
  declarations: [AppComponent, CadastrarSelecaoComponent, CadastrarJogoComponent, ListarJogoComponent, PalpitarJogoComponent, ListarSelecaoComponent, ListarSelecoesComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
